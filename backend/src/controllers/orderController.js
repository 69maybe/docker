...
exports.createOrder = async (req, res, next) => {
  ...
  try {
    ...
    // Tự động cập nhật trạng thái bàn thành "co_nguoi" khi có đơn hàng
...
exports.markOrderPayment = async (req, res, next) => {
  ...
  try {
    ...
    // Kiểm tra đơn hàng có tồn tại và đã phục vụ chưa
    ...
    // Chỉ cho phép thanh toán khi đơn hàng đã phục vụ
    ...
    // Nếu đã thanh toán, tự động chuyển trạng thái bàn thành "trong"
